...
################################################################
# This is a generated script based on design: mini_system
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.CLKIN1_JITTER_PS {50.0} CONFIG.CLKOUT1_JITTER {112.316} CONFIG.CLKOUT1_PHASE_ERROR {89.971} CONFIG.CLK_IN1_BOARD_INTERFACE {sys_diff_clock} CONFIG.MMCM_CLKFBOUT_MULT_F {5.000} CONFIG.MMCM_CLKIN1_PERIOD {5.0} CONFIG.PRIM_SOURCE {Differential_clock_capable_pin} CONFIG.RESET_BOARD_INTERFACE {reset}  ] $clk_wiz_1
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net CLK_IN1_D_1 [get_bd_intf_ports sys_clk] [get_bd_intf_pins clk_wiz_1/CLK_IN1_D]
  ...
  set_property -dict [ list HDL_ATTRIBUTE.MARK_DEBUG {true}  ] [get_bd_intf_nets microblaze_0_axi_periph_M00_AXI]
